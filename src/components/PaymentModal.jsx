  ...
  const generatePaymentLink = async () => {
    ...
    try {
      ...
      if (errorMessage.includes("Mercado Pago no está configurado")) {
        errorMessage =
          "Error de configuración: Mercado Pago no está configurado correctamente. Verifica las credenciales en .env.local";
      } else if (errorMessage.includes("Firebase no está configurado")) {
        errorMessage =
          "Error de configuración: Firebase no está configurado correctamente. Verifica las credenciales en .env.local";
      }
