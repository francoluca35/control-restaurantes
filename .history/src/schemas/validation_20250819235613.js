...
export const restaurantSchema = z.object({
  ...
  moneda: z.enum(["USD", "ARS"], {
    ...
    // Si formaPago es "mercadopago", moneda es requerida
    if (ctx.parent.formaPago === "mercadopago" && !val) {
      return false;
    }
    return true;
  }, {
    message: "Debe seleccionar una moneda cuando el pago es con Mercado Pago",
  }),
});
