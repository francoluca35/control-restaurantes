...
export const createPaymentPreference = async (paymentData) => {
  ...
  try {
    const preference = {
      ...
      back_urls: {
        success: paymentData.successUrl || `${process.env.NEXT_PUBLIC_BASE_URL}/payment/success`,
        failure: paymentData.failureUrl || `${process.env.NEXT_PUBLIC_BASE_URL}/payment/failure`,
        pending: paymentData.pendingUrl || `${process.env.NEXT_PUBLIC_BASE_URL}/payment/pending`,
      },
      auto_return: 'approved',
      external_reference: paymentData.externalReference,
      notification_url: paymentData.notificationUrl || `${process.env.NEXT_PUBLIC_BASE_URL}/api/webhooks/mercadopago`,
      expires: true,
