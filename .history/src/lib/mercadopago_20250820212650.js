...
const configureMercadoPago = () => {
  ...
  if (!accessToken || accessToken === "APP_USR-3805637089394876-062320-da82ba95333079012f1e0776e1963bba-740803134") {
    console.warn("⚠️ MERCADOPAGO_ACCESS_TOKEN no configurado correctamente en .env.local");
    console.warn("⚠️ Por favor, verifica que tengas las credenciales correctas de MercadoPago");
    return false;
  }
