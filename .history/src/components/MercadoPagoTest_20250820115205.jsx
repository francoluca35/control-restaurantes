  ...
  if (isLoading) {
    return (
      <div className="p-4 bg-blue-50 rounded-lg">
        <div className="text-blue-600 font-medium">Probando configuración de MercadoPago...</div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="p-4 bg-gray-50 rounded-lg">
        <h3 className="font-medium text-gray-900 mb-2">Configuración de MercadoPago</h3>
        <div className="space-y-1 text-sm">
          <div className="flex justify-between">
            <span>Estado:</span>
            <span className={configInfo.isConfigured ? 'text-green-600' : 'text-red-600'}>
          ...
          <div className="flex justify-between">
            ...
            <span className={configInfo.publicKey === 'Configurado' ? 'text-green-600' : 'text-red-600'}>
              {configInfo.publicKey}
            </span>
          </div>
          <div className="flex justify-between">
            <span>Client ID:</span>
            <span className={configInfo.clientId === 'Configurado' ? 'text-green-600' : 'text-red-600'}>
              {configInfo.clientId}
            </span>
          </div>
          <div className="flex justify-between">
            <span>Access Token:</span>
            <span className={configInfo.accessToken === 'Configurado' ? 'text-green-600' : 'text-red-600'}>
              {configInfo.accessToken}
            </span>
          </div>
          <div className="flex justify-between">
            <span>Client Secret:</span>
            <span className={configInfo.clientSecret === 'Configurado' ? 'text-green-600' : 'text-red-600'}>
