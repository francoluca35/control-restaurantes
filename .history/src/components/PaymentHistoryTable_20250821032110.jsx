                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-center">
                        {payment.status === "approved" ? (
                          <button
                            ...
                            className="inline-flex items-center justify-center w-8 h-8 text-blue-600 hover:text-blue-800 hover:bg-blue-50 rounded-full transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed group"
