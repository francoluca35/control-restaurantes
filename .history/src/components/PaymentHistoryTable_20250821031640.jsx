...
const PaymentHistoryTable = ({ restaurantId = null }) => {
  const { paymentHistory, loading, error, loadPaymentHistory, downloadContract } = usePaymentHistory();
      ...
      {paymentHistory.statistics && (
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="bg-white p-4 rounded-lg shadow border">
            ...
            <p className="text-2xl font-bold text-gray-900">{paymentHistory.statistics.totalPayments}</p>
          </div>
          <div className="bg-white p-4 rounded-lg shadow border">
            <h3 className="text-sm font-medium text-gray-500">Pagos Aprobados</h3>
            <p className="text-2xl font-bold text-green-600">{paymentHistory.statistics.approvedPayments}</p>
          </div>
          <div className="bg-white p-4 rounded-lg shadow border">
      ...
      <div className="bg-white shadow rounded-lg overflow-hidden">
        ...
        {allPayments.length === 0 ? (
          <div className="p-8 text-center">
            <p className="text-gray-500">No se encontraron pagos en el historial</p>
          </div>
        ) : (
                ...
                {allPayments.map((payment) => {
                  ...
                  return (
                    <tr key={payment.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        {restaurant ? (restaurant.nombre || restaurant.name) : "N/A"}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
