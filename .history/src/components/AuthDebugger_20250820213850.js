  ...
  useEffect(() => {
    const updateDebugInfo = () => {
      ...
      const info = {
        ...
        localStorage: {
          superAdminUser: typeof window !== "undefined" ? localStorage.getItem("superAdminUser") : null,
          superAdminRole: typeof window !== "undefined" ? localStorage.getItem("superAdminRole") : null,
          hasSuperAdminUser: typeof window !== "undefined" ? !!localStorage.getItem("superAdminUser") : false,
          hasSuperAdminRole: typeof window !== "undefined" ? !!localStorage.getItem("superAdminRole") : false,
        },
      };
