...
const PaymentModal = ({
  ...
  const generatePaymentLink = async () => {
    ...
    try {
      ...
      const restaurantId = restaurantData.id || restaurantData.nombre?.replace(/\s+/g, '_').toLowerCase();
            ...
            <div className="space-y-4">
             ...
             <div className="text-center">
               ...
               <div className="bg-gray-50 p-3 rounded-lg mb-4 text-left">
                 <h4 className="font-medium text-gray-900 mb-2">📋 Información de Debug:</h4>
                 <div className="text-sm text-gray-600 space-y-1">
                   <p><strong>Restaurante:</strong> {restaurantData?.nombre || restaurantData?.name || "No disponible"}</p>
                   <p><strong>ID:</strong> {restaurantData?.id || "No disponible"}</p>
                   <p><strong>Monto:</strong> ${amount || "No disponible"}</p>
                   <p><strong>Moneda:</strong> {restaurantData?.moneda || "ARS"}</p>
                 </div>
               </div>
