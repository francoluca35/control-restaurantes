      ...
      if (data.success) {
        ...
        const envCheck = {
          firebase: {
            ...
            storageBucket: data.firebase.status.storageBucket === "✅ Configurada",
            messagingSenderId: data.firebase.status.messagingSenderId === "✅ Configurada",
            appId: data.firebase.status.appId === "✅ Configurada",
          },
          mercadopago: {
            accessToken: data.mercadopago.status.accessToken === "✅ Configurada",
