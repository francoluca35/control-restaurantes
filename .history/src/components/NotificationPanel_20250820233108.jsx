                    ...
                    <div key={index} className="text-xs">
                      ...
                      {error.data?.errorCode && (
                        <div className="text-red-300">
                          Código: {error.data.errorCode}
                        </div>
                      )}
                      {error.data?.indexUrl && (
                        <div className="mt-2">
                          <a
                            href={error.data.indexUrl}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="bg-blue-600 text-white px-2 py-1 rounded text-xs hover:bg-blue-700 transition-colors inline-block"
                          >
