      ...
      <div className="mb-6">
       ...
       {detailedInfo && (
         <div className="bg-gray-800 p-4 rounded-lg mb-4">
           <h4 className="font-medium text-yellow-300 mb-2">🔍 Información del Servidor:</h4>
           <div className="text-sm space-y-2 text-gray-300">
             <p><strong>Timestamp:</strong> {detailedInfo.timestamp}</p>
             <p><strong>Environment:</strong> {detailedInfo.environment}</p>
             
             <div className="mt-3">
               <h5 className="font-medium text-blue-300 mb-1">Firebase Values:</h5>
               <div className="space-y-1 text-xs">
                 <p><strong>API Key:</strong> {detailedInfo.firebase.values.apiKey}</p>
                 <p><strong>Auth Domain:</strong> {detailedInfo.firebase.values.authDomain}</p>
                 <p><strong>Project ID:</strong> {detailedInfo.firebase.values.projectId}</p>
                 <p><strong>Storage Bucket:</strong> {detailedInfo.firebase.values.storageBucket}</p>
                 <p><strong>Messaging Sender ID:</strong> {detailedInfo.firebase.values.messagingSenderId}</p>
                 <p><strong>App ID:</strong> {detailedInfo.firebase.values.appId}</p>
               </div>
             </div>
             
             <div className="mt-3">
               <h5 className="font-medium text-blue-300 mb-1">MercadoPago Values:</h5>
               <div className="space-y-1 text-xs">
                 <p><strong>Access Token:</strong> {detailedInfo.mercadopago.values.accessToken}</p>
                 <p><strong>Public Key:</strong> {detailedInfo.mercadopago.values.publicKey}</p>
               </div>
             </div>
           </div>
         </div>
