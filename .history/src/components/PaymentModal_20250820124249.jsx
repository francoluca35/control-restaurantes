...
const PaymentModal = ({
  ...
  const generatePaymentLink = async () => {
    ...
    if (!restaurantData.codigoActivacion && !restaurantData.nombre) {
      setError("El restaurante debe tener un código de activación y nombre válido");
      setStep("error");
      return;
    }
            ...
            <div className="text-center">
              ...
              <div className="bg-gray-50 p-3 rounded-lg mb-4 text-left">
                ...
                <div className="text-sm text-gray-600 space-y-1">
                  ...
                  <p>
                    <strong>Código de Activación:</strong> {restaurantData?.codigoActivacion || "No disponible"}
                  </p>
                  <p>
