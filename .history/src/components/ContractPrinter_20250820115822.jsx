  ...
  const generateContractData = () => {
    const contract = {
      ...
      payment: {
        ...
        date: paymentData.date_approved ? new Date(paymentData.date_approved).toLocaleDateString('es-AR') : new Date().toLocaleDateString('es-AR'),
    ...
    const contractContent = `
      ...
      <body>
        ...
        <div class="section">
          ...
          <div class="info-grid">
            <div class="info-item">
              <span class="info-label">Nombre:</span> ${contractData.restaurant.name}
            </div>
            <div class="info-item">
              <span class="info-label">Propietario:</span> ${contractData.restaurant.owner}
            </div>
            <div class="info-item">
              <span class="info-label">Dirección:</span> ${contractData.restaurant.address}
            </div>
            <div class="info-item">
              <span class="info-label">Teléfono:</span> ${contractData.restaurant.phone}
            </div>
            <div class="info-item">
              <span class="info-label">Email:</span> ${contractData.restaurant.email}
            </div>
          </div>
        </div>
        ...
        <div class="section">
          ...
          <div class="info-grid">
            <div class="info-item">
              <span class="info-label">Monto:</span> $${contractData.payment.amount}
            </div>
            <div class="info-item">
              <span class="info-label">Método:</span> ${contractData.payment.method}
            </div>
            <div class="info-item">
              <span class="info-label">Fecha de Pago:</span> ${contractData.payment.date}
            </div>
            <div class="info-item">
              <span class="info-label">ID de Transacción:</span> ${contractData.payment.transactionId}
            </div>
          </div>
        </div>
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="p-4 bg-gray-50 border border-gray-200 rounded-lg">
        ...
        <div className="space-y-2 text-sm">
          ...
          <div className="flex justify-between">
            ...
            <span className="font-medium">${contractData.payment.amount}</span>
          </div>
          <div className="flex justify-between">
      ...
      <div className="text-xs text-gray-600 bg-gray-50 p-3 rounded">
        <p><strong>Información del contrato:</strong></p>
