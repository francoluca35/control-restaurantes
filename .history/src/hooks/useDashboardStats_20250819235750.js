  ...
  const loadDashboardStats = useCallback(async () => {
    try {
      ...
      restaurantsSnapshot.docs.forEach((doc) => {
        ...
        if (restaurantData.moneda === "ARS" && ingresosMensualesRestaurante > 0) {
          // Convertir ARS a USD usando la tasa de cambio
      ...
      ingresosMensualesARS = ingresosMensualesUSD * rates.ARS;
