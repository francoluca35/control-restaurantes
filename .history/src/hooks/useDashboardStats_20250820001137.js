    ...
    try {
      ...
      restaurantsSnapshot.docs.forEach((doc) => {
        ...
        if (restaurantData.moneda === "ARS") {
          ...
          console.log(
            `📊 Restaurante ${restaurantData.nombre}: ${ingresosMensualesRestaurante} ARS (moneda: ARS)`
          );
        } else {
          ...
          console.log(
            ...
            }: ${ingresosMensualesRestaurante} USD (moneda: ${
      ...
      console.log(`💰 Ingresos mensuales totales: USD ${ingresosMensualesUSD.toFixed(2)}, ARS ${ingresosMensualesARS.toFixed(2)}`);
