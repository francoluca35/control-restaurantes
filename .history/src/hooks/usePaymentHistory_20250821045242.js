      ...
      paymentData.currency || paymentData.currency_id || "ARS"
        ...
        <div class="signature-section">
            ...
            <div class="logo">
              ${
                logoBase64
                  ...
                  : '<div style="width: 100%; height: 100%; background: transparent; display: flex; align-items: center; justify-content: center; font-weight: bold; font-size: 32px; color: #8B5CF6;">CM</div>'
              }
            </div>
          ...
          <div class="signature-box">
            ...
            <div class="signature-name">Franco Lucca Pavera</div>
            <div class="signature-line"></div>
