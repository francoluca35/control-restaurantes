    ...
    async (paymentData, restaurantData) => {
      try {
        ...
        try {
          ...
          if (logoBase64) {
            // Logo real
            doc.addImage(logoBase64, "PNG", 95, currentY - 15, 20, 20);
          } else {
            ...
            doc.setFontSize(12);
            doc.setFont("helvetica", "bold");
            doc.text("DEAMON DD", 105, currentY - 8, { align: "center" });
            doc.setFontSize(18);
            doc.text("CM", 105, currentY + 2, { align: "center" });
            doc.setFontSize(8);
            doc.text("Comandas Multiples", 105, currentY + 12, { align: "center" });
          }
        } catch (error) {
          // Logo fallback con diseño mejorado
          doc.setFillColor(...primaryColor);
      ...
      paymentData.currency || paymentData.currency_id || "ARS"
        ...
        <div class="signature-section">
          <div class="signature-box">
            ...
            <div style="font-size: 11px; color: #666; margin-top: 10px;">DNI: ${
              restaurantData.dni || "N/A"
            }</div>
          </div>
            ...
            <div class="logo">
              ${
                logoBase64
                  ...
                  : '<div style="width: 100%; height: 100%; background: linear-gradient(135deg, #002060, #0040a0); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: bold; font-size: 24px; color: white;">CW</div>'
              }
            </div>
