  ...
  const downloadContract = useCallback(
    async (paymentData, restaurantData) => {
      try {
        ...
        currentY += 8;
        doc.text("El Proveedor se compromete a brondarle un servicio de calidad al Cliente, incluyendo la planificación, ejecución y supervisión de estrategias de contenido.", 25, currentY);
