        ...
        <div class="section">
          ...
          <div class="info-grid">
            <div class="info-item">
              ...
              } ${paymentData.currency || paymentData.currency_id || "ARS"}</span>
            </div>
            <div class="info-item">
            ...
            <div class="logo">
              ${
                logoBase64
                  ...
                  : '<div style="width: 100%; height: 100%;  display: flex; align-items: center; justify-content: center; font-weight: bold; font-size: 32px;">CM</div>'
              }
            </div>
