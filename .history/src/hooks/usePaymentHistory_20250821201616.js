  ...
  const downloadContract = useCallback(
    async (paymentData, restaurantData) => {
      try {
        ...
        currentY += 8;
        doc.text("Teléfono: (11) ", 25, currentY);
        currentY += 8;
        ...
        <div class="section">
          ...
          <div class="info-grid">
            ...
            <div class="info-item">
              ...
              <span class="info-value">${restaurantData.dni || paymentData.dni || "N/A"}</span>
            </div>
            <div class="info-item">
              <span class="info-label">Dirección:</span>
              <span class="info-value">${
        ...
        <div class="section">
          ...
          <div class="info-grid">
            <div class="info-item">
              ...
              <span class="info-value">${restaurantData.codigoActivacion || "N/A"}</span>
            </div>
            <div class="info-item">
              <span class="info-label">Cantidad de Usuarios:</span>
              <span class="info-value">${restaurantData.cantUsuarios || "1"}</span>
            </div>
            <div class="info-item">
              <span class="info-label">Tipo de Servicio:</span>
              <span class="info-value">${restaurantData.tipoServicio || "Básico"}</span>
            </div>
            <div class="info-item">
              <span class="info-label">Módulo de Finanzas:</span>
              <span class="info-value">${restaurantData.finanzas ? "Incluido" : "No incluido"}</span>
            </div>
            <div class="info-item">
      ...
      paymentData.currency || paymentData.currency_id || "ARS"
        ...
        <div class="section">
          ...
          <ol class="terms-list">
            ...
            <li><strong>RESOLUCIÓN:</strong> Cualquiera de las partes puede rescindir el contrato con 30 días de anticipación por escrito.</li>
        ...
        <div class="signature-section">
          <div class="signature-box">
            <div class="signature-name">${restaurantData.propietario || restaurantData.nombreCompleto || "Cliente"}</div>
            <div class="signature-line"></div>
            <div class="signature-title">Firma del Cliente</div>
            <div style="font-size: 11px; color: #666; margin-top: 10px;">DNI: ${restaurantData.dni || "N/A"}</div>
          </div>
            ...
            <div class="logo">
              ${
                logoBase64
                  ...
                  : '<div style="width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; font-weight: bold; font-size: 24px; color: white;">CW</div>'
              }
            </div>
            <div class="logo-text">DeamonDD<br>By FranComputer</div>
          </div>
          <div class="signature-box">
            <div class="signature-name">Franco Luca Parera</div>
            <div class="signature-line"></div>
            <div class="signature-title">Firma del Prestador</div>
            <div style="font-size: 11px; color: #666; margin-top: 10px;">DeamonDD By FranComputer</div>
          </div>
        </div>
