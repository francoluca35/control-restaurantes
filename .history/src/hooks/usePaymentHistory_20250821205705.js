  ...
  const downloadContract = useCallback(
    async (paymentData, restaurantData) => {
      try {
        ...
        const primaryColor = [64, 32, 128]; // Azul corporativo
        ...
        const legalTerms = [
          ...
          "   El contrato tiene una duración de 30 días o 1 año desde la fecha de activación.",
          ...
          "   El sistema es propiedad exclusiva del prestador.",
        ...
        doc.setFont("helvetica", "normal");
        doc.setTextColor(...textColor);
        doc.text("Firma del  CEO DEAMON DD", 155, currentY + 10, {
          align: "center",
        });
