  ...
  const downloadContract = useCallback(
    async (paymentData, restaurantData) => {
      try {
        ...
        doc.setFontSize(10);
        doc.setTextColor(...blackColor);
        doc.text(`Monto: $${paymentData.amount || "0"} (${restaurantData.moneda || "USD"})`, 20, 285);
        doc.text(
        ...
        doc.setLineWidth(1);
        doc.line(20, termsYPosition + 45, 90, termsYPosition + 45);
        doc.line(120, termsYPosition + 45, 190, termsYPosition + 45);
        ...
        doc.text("DEAMONDD BY FRANCOMPUTER", 155, termsYPosition + 60, {
          align: "center",
        });
