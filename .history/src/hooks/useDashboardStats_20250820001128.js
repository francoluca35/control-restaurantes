    ...
    try {
      ...
      restaurantsSnapshot.docs.forEach((doc) => {
        ...
        if (restaurantData.moneda === "ARS") {
          ...
          console.log(`📊 Restaurante ${restaurantData.nombre}: ${ingresosMensualesRestaurante} ARS (moneda: ARS)`);
        } else {
          // Por defecto USD o si no tiene moneda especificada
          ingresosMensualesUSD += ingresosMensualesRestaurante;
          console.log(`📊 Restaurante ${restaurantData.nombre}: ${ingresosMensualesRestaurante} USD (moneda: ${restaurantData.moneda || 'USD'})`);
        }
