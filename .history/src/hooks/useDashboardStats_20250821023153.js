        ...
        if (paymentData.status === "approved") {
          ...
          const isAnnualPayment =
           ...
           const isARS =
             ...
             paymentData.moneda === "ARS" ||
             (paymentData.paymentId &&
               typeof paymentData.paymentId === "string" &&
               paymentData.paymentId.toUpperCase().includes("ARS")) ||
             (paymentData.paymentMethod &&
               paymentData.paymentMethod.toLowerCase().includes("ars")) ||
             // Para pagos de Mercado Pago, usar el nuevo campo es_usd
             paymentData.es_usd === false ||
             // Para pagos de Mercado Pago, verificar si el ID empieza con ARS_
             (paymentData.paymentId &&
               typeof paymentData.paymentId === "string" &&
               paymentData.paymentId.startsWith("ARS_"));

          // Log para debug
          if (paymentData.paymentMethod === "mercadopago") {
            console.log("🔍 Debug Mercado Pago:", {
              paymentId: paymentData.paymentId,
              pago_arg: paymentData.pago_arg,
              pago_usd: paymentData.pago_usd,
          ...
          // Determinar si es USD usando los nuevos campos
          const isUSD =
            paymentData.currency === "USD" ||
            paymentData.moneda === "USD" ||
            paymentData.pago_usd === true ||
            (paymentData.paymentId &&
              typeof paymentData.paymentId === "string" &&
