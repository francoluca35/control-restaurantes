  ...
  useEffect(() => {
    ...
    if (!db) {
      ...
      addNotification({
        ...
        message: "Firebase no está configurado correctamente. Verifica las variables de entorno.",
        autoRemove: false,
      });
      return;
    }
      ...
      const unsubscribe = onSnapshot(
        ...
        (error) => {
          ...
          if (error.code === "failed-precondition") {
            const errorMessage = "Se requiere crear un índice en Firebase. Haz clic en el enlace para crearlo automáticamente.";
            ...
            addNotification({
              ...
              data: {
                ...
                indexUrl: "https://console.firebase.google.com/v1/r/project/comandas-multiples/firestore/indexes?create_composite=Cldwcm9qZWN0cy9jb21hbmRhcy1tdWx0aXBsZXMvZGF0YWJhc2VzLyhkZWZhdWx0KS9jb2xsZWN0aW9uR3JvdXBzL3Jlc3RhdXJhbnRlcy9pbmRleGVzL18QARoOCgplc3RhZG9QYWdvEAEaDQoJZmVjaGFQYWdvEAIaDAoIX19uYW1lX18QAg",
              },
            });
          } else {
            // Determinar el tipo de error y mostrar mensaje apropiado
            let errorMessage = "No se pueden recibir notificaciones de pagos en tiempo real";
            
            if (error.code === "permission-denied") {
              errorMessage = "No tienes permisos para acceder a las notificaciones de pagos";
            } else if (error.code === "unavailable") {
              errorMessage = "Servicio de notificaciones temporalmente no disponible";
