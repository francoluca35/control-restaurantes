  ...
  const downloadContract = useCallback(
    async (paymentData, restaurantData) => {
      try {
        ...
        doc.setFontSize(16);
        doc.setTextColor(...violetColor);
        doc.text("TERMINOS & CONDICIONES", 20, 365);
        ...
        let termsYPosition = 385;
        terms.forEach((term, index) => {
          if (termsYPosition < 280) {
        ...
        doc.setFontSize(12);
        doc.setTextColor(...blackColor);
        doc.text("Franco Luca Parera", 105, termsYPosition + 45, {
          align: "center",
        });
        ...
        doc.setFontSize(10);
        doc.setTextColor(...blackColor);
        doc.text("Firma del Cliente", 55, termsYPosition + 90, {
          align: "center",
        });
        doc.text("Firma Empresarial", 155, termsYPosition + 90, {
          align: "center",
        });
