  ...
  const downloadContract = useCallback(
    async (paymentData, restaurantData) => {
      try {
        ...
        currentY += 8;
        doc.text("El Proveedor se compromete a gestionar la cuenta digital del Cliente, incluyendo la planificación, ejecución y supervisión de estrategias de contenido.", 25, currentY);
