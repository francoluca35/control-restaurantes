  ...
  const loadDashboardStats = useCallback(async () => {
    try {
      ...
      restaurantsSnapshot.docs.forEach((doc) => {
        ...
        let esPagoAnual = restaurantData.periodicidad === "anual" || restaurantData.tipoPago === "anual";
      ...
      console.log(
        `💰 Ingresos totales: USD ${netoDolares.toFixed(2)} (Mensual: ${ingresosMensualesUSD.toFixed(2)}, Anual: ${ingresosAnualesUSD.toFixed(2)}), ARS ${netoPesos.toFixed(2)} (Mensual: ${ingresosMensualesARS.toFixed(2)}, Anual: ${ingresosAnualesARS.toFixed(2)})`
      );
