  ...
  const downloadContract = useCallback(
    async (paymentData, restaurantData) => {
      try {
        ...
        currentY += 8;
        doc.text("El Proveedor se compromete a brindarle un servicio de calidad al Cliente, con un equipo de trabajo dedicado a la gestión de su negocio.", 25, currentY);
        currentY += 8;
