        ...
        (snapshot) => {
          ...
          setConnectionError(null);
             ...
             if (change.type === "modified") {
               ...
               console.log("🔍 Verificando condiciones para notificación:", {
                 estadoPagoEsPagado: restaurantData.estadoPago === "pagado",
                 tieneFechaPago: !!restaurantData.fechaPago,
                 previousDataExiste: !!previousData,
                 previousEstadoPago: previousData?.estadoPago,
                 esPagoRecienAprobado: !previousData || previousData.estadoPago !== "pagado"
               });
              ...
              if (
                ...
                addNotification({
                  ...
                  message: `Se acreditó el pago de $${monto} ${moneda} para el restaurante ${restaurantData.nombre}`,
                  data: {
                    restaurantId: change.doc.id,
                    amount: monto,
                    currency: moneda,
                    paymentId: restaurantData.ultimoPago?.paymentId,
                  },
                });
