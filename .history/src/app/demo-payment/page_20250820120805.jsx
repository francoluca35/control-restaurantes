...
const DemoPaymentPage = () => {
  ...
  const handlePaymentSuccess = (paymentLink) => {
    ...
    alert("¡Link de pago generado exitosamente! Revisa la consola para ver el link.");
  };
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Demostración del modal que se abre al registrar un restaurante con MercadoPago
          </p>
        </div>
        ...
        <div className="mt-8 bg-blue-50 p-6 rounded-lg">
          ...
          <div className="space-y-2 text-sm text-blue-800">
            <p><strong>1. Al hacer clic en "Registrar y Generar Link de Pago":</strong></p>
            ...
            <p><strong>2. Durante el procesamiento:</strong></p>
            <ul className="list-disc list-inside ml-4 space-y-1">
            ...
            <p><strong>3. Una vez generado el link:</strong></p>
            <ul className="list-disc list-inside ml-4 space-y-1">
            ...
            <p><strong>4. El cliente puede pagar usando:</strong></p>
            <ul className="list-disc list-inside ml-4 space-y-1">
