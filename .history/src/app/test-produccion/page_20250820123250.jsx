      ...
      <div className="max-w-2xl mx-auto px-4">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border mb-6">
          ...
          <div className="space-y-2 text-sm">
            ...
            <p><strong>Propietario:</strong> {testRestaurantData.propietario}</p>
          </div>
        </div>
        ...
        <div className="mt-8 bg-green-50 p-6 rounded-lg">
          ...
          <div className="space-y-2 text-sm text-green-800">
            ...
            <p>2. El modal se abrirá y creará una preferencia REAL en MercadoPago</p>
            ...
            <p>6. ⚠️ <strong>Este link generará pagos reales</strong></p>
          </div>
        </div>
        ...
        <div className="mt-6 bg-yellow-50 p-6 rounded-lg">
          ...
          <div className="space-y-2 text-sm text-yellow-800">
            ...
            <p>• Los webhooks actualizarán automáticamente el estado del restaurante</p>
          </div>
        </div>
