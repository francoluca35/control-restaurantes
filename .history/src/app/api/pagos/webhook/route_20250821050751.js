...
export async function POST(request) {
  try {
    ...
    // Registrar la transacción con todos los datos del restaurante
    await recordPaymentTransaction(paymentData, restaurantId, restaurantData);
...
async function recordPaymentTransaction(
  ...
  try {
    ...
    const transaction = {
      ...
      codigoActivacion: restaurantData.codigoActivacion,
      cantidadUsuarios: restaurantData.cantidadUsuarios,
      conFinanzas: restaurantData.conFinanzas,
      password: restaurantData.password,
      logo: restaurantData.logo,
      // Datos del propietario
      nombreCompleto: restaurantData.nombreCompleto || "N/A",
      dni: restaurantData.dni || "N/A",
      // Datos del servicio
      tipoServicio: restaurantData.tipoServicio || "sinFinanzas",
      formaPago: restaurantData.formaPago || "mercadopago",
      periodicidad: restaurantData.periodicidad || "mensual",
      moneda: restaurantData.moneda || currency,
      // Datos del pago
      ...
      propietario: restaurantData.nombreCompleto || "Propietario",
      // Timestamps
      createdAt: new Date(),
      updatedAt: new Date(),
    };
