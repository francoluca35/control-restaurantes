      ...
      if (camposFaltantes.length > 0) {
        try {
          ...
          if (!paymentData.email) {
            updateData.email = `${paymentData.restaurantId || paymentData.externalReference || transactionId}@restaurante.com`;
          }
        ...
        console.log(`⏭️ Transacción ${transactionId} ya tiene todos los campos necesarios`);
        skippedCount++;
      }
    }
