...
export async function POST(request) {
  try {
    ...
    console.log("💰 Guardando transacción de pago con todos los datos:", paymentTransactionData);
    
    await addDoc(collection(db, "paymentTransactions"), paymentTransactionData);
