...
export async function POST(request) {
  try {
    ...
    // Verificar que el restaurante existe (permitir IDs de prueba)
    const isTestRestaurant = restaurantId.startsWith('test-') || restaurantId.startsWith('demo-');
    ...
    // Actualizar el restaurante con la información del pago
