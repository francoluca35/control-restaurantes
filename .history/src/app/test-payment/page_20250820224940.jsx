        ...
        <div className="space-y-6">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
            ...
            <div className="space-y-1 text-sm text-blue-800 dark:text-blue-200">
              <p><strong>Monto:</strong> $1.00 ARS</p>
              <p><strong>Descripción:</strong> Pago de Prueba - 1 Peso</p>
              <p><strong>Referencia:</strong> TEST-PAYMENT-001</p>
              <p><strong>Moneda:</strong> Pesos Argentinos</p>
            </div>
          </div>
          ...
          {paymentUrl && (
            <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
              ...
              <p className="text-green-800 dark:text-green-200 text-sm mb-3">
                Haz clic en el botón para ir a MercadoPago y completar el pago de prueba.
              </p>
              <a
                href={paymentUrl}
                target="_blank"
