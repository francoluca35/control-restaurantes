...
export default function TestPaymentPage() {
  ...
  const handleTestPayment = async () => {
    ...
    try {
      ...
      if (data.success) {
        console.log("✅ Pago de prueba creado:", data.preference);
        setPaymentUrl(data.preference.initPoint);
      } else {
        throw new Error(data.error || "Error al crear el pago de prueba");
      }
    } catch (err) {
      console.error("❌ Error creando pago de prueba:", err);
