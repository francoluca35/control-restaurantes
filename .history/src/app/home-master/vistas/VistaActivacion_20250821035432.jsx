  ...
  const onSubmit = useCallback(
    async (data) => {
      try {
        ...
        console.log("🔑 Código de activación:", data.codigoActivacion);
        console.log("👥 Cantidad de usuarios:", data.cantidadUsuarios);
        console.log("💰 Con finanzas:", data.conFinanzas);
        ...
        // Si el pago es en efectivo, los datos ya se guardaron en /api/restaurants
        if (data.formaPago === "efectivo") {
          console.log("💰 Pago en efectivo - Los datos ya se guardaron en /api/restaurants");
          console.log("🏪 Restaurant ID:", createdRestaurant.id || createdRestaurant.restaurantId);
