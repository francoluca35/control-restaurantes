...
export default function VistaActivacion() {
  ...
  const precioCalculado = useMemo(() => {
    if (watchedValues.tipoServicio && watchedValues.periodicidad) {
      const precioUSD = precios[watchedValues.tipoServicio]?.[watchedValues.periodicidad] || 0;
    ...
    return 0;
  }, [watchedValues.tipoServicio, watchedValues.periodicidad, watchedValues.moneda, convertUsdToArs]);
  ...
  const generatePDF = useCallback(
    (data) => {
      ...
      doc.text(`Precio: ${formatPrice(precioCalculado, data.moneda || "USD")}`, 20, 180);
              ...
              <div className="space-y-1.5">
                <label className="block text-sm font-semibold text-slate-200">
                  ...
                  {watchedValues.moneda === "ARS" && ratesLoading && (
                    <span className="text-xs text-blue-400 ml-2">(Actualizando...)</span>
                  )}
                </label>
