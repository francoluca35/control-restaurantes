  ...
  const onSubmit = useCallback(
    async (data) => {
      try {
        ...
        console.log("🔍 Propiedades del restaurante:", Object.keys(createdRestaurant));
        ...
        if (data.formaPago === "efectivo") {
          ...
          const restaurantId = createdRestaurant.id || 
                              createdRestaurant.docId || 
                              createdRestaurant._id || 
                              createdRestaurant.restaurantId ||
                              data.codigoActivacion; // Usar código de activación como fallback
