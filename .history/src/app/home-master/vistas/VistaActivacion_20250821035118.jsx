      ...
      try {
        ...
        if (data.formaPago === "efectivo") {
          ...
          try {
            ...
            console.log("💰 Datos a enviar al endpoint de pago en efectivo:", paymentData);
            ...
            if (!response.ok) {
              ...
              throw new Error(
                `Error al registrar pago en efectivo: ${response.status} - ${errorText}`
              );
            }

            const result = await response.json();
            console.log("✅ Pago en efectivo registrado:", result);
          } catch (error) {
            console.error("❌ Error registrando pago en efectivo:", error);
            // Continuar con el flujo aunque falle el registro del pago
          }
        }
