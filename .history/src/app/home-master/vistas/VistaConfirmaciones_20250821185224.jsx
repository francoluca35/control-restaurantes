                        ...
                        pago.status === "pagado" ? (
                          <div className="relative group">
                            <button
                              ...
                              className="inline-flex items-center justify-center w-12 h-12 bg-gradient-to-r from-bgree-700 to-red-500 hover:from-blue-100 hover:to-purple-600 rounded-xl transition-all duration-300 transform hover:scale-110 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl"
