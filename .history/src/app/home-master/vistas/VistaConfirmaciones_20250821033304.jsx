...
export default function VistaConfirmaciones() {
  ...
  const handleDownloadContract = async (pago) => {
    try {
      ...
      if (!restaurant) {
        console.log("🔍 Restaurante no encontrado en restaurantes, buscando en codigosactivacion...");
        
        try {
          // Buscar en la colección codigosactivacion usando el restaurantId como código de activación
          const codigosRef = collection(db, "codigosactivacion");
          const q = query(codigosRef, where("codActivacion", "==", pago.restaurantId));
          ...
          if (!querySnapshot.empty) {
            ...
            console.log("✅ Datos encontrados en codigosactivacion:", codigoData);
            
            // Crear objeto restaurante con los datos de codigosactivacion
            restaurant = {
              ...
              codigoActivacion: codigoData.codActivacion || pago.restaurantId,
              password: codigoData.password || "N/A",
              periodicidad: codigoData.periodicidad || getPaymentPeriodicity(pago),
              cantUsuarios: codigoData.cantUsuarios || "1",
              finanzas: codigoData.finanzas || false,
            };
          } else {
            console.log("❌ No se encontró en codigosactivacion, creando objeto básico");
            ...
            restaurant = {
              ...
              codigoActivacion: pago.restaurantId,
              password: "N/A",
        ...
        restaurant.codigoActivacion = restaurant.codigoActivacion || pago.restaurantId;
        restaurant.password = restaurant.password || "N/A";
        restaurant.periodicidad = restaurant.periodicidad || getPaymentPeriodicity(pago);
        restaurant.cantUsuarios = restaurant.cantUsuarios || "1";
        restaurant.finanzas = restaurant.finanzas || false;
      }

      console.log("📄 Datos finales del restaurante para contrato:", restaurant);
