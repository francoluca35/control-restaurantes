                ...
                <div className="px-3 py-2 bg-slate-800/50 border border-slate-600/50 rounded-lg text-slate-100 text-sm">
                  ...
                  {watchedValues.moneda === "ARS" && (
                    <div className="text-xs text-slate-400 mt-1">
                      ...
                      <br />
                      <span className="text-yellow-400">⚠️ Incluye recargo del 15% para pagos en pesos argentinos</span>
                    </div>
                  )}
                </div>
              </div>
          ...
          <div className="flex items-start space-x-2">
            ...
            <div>
              ...
              <ul className="text-xs text-slate-400 space-y-0.5">
                ...
                <li>• Los pagos en pesos argentinos incluyen un recargo del 15%</li>
              </ul>
            </div>
          </div>
        </div>
