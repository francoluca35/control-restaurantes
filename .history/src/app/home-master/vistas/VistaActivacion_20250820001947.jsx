  ...
  const onSubmit = useCallback(
    async (data) => {
      try {
        ...
        // Si el pago es con Mercado Pago, procesar el pago
        if (data.formaPago === "mercadopago") {
          try {
            await processRestaurantPayment(createdRestaurant);
            // No mostrar éxito aquí porque se redirige a Mercado Pago
            return;
          } catch (error) {
            console.error("Error procesando pago con Mercado Pago:", error);
            // Continuar con el flujo normal si falla el pago
          }
        }
