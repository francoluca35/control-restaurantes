    ...
    async (data) => {
      try {
        ...
        if (data.formaPago === "efectivo") {
          ...
          console.log("📝 Description:", `Activación de restaurante - ${data.tipoServicio} - ${data.periodicidad}`);
          ...
          try {
            ...
            if (!response.ok) {
              ...
              throw new Error(`Error al registrar pago en efectivo: ${response.status} - ${errorText}`);
            }
