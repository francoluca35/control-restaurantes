  ...
  return (
    <div className="bg-gradient-to-r from-gray-800 to-gray-900 rounded-2xl shadow-2xl p-6 lg:p-8 border border-gray-700">
      ...
      <div className="mt-8 grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
        ...
        <div className="bg-gradient-to-r from-purple-900/50 to-purple-800/50 rounded-xl p-4 lg:p-6 border border-purple-700/50 backdrop-blur-sm">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-purple-300 text-sm lg:text-base font-medium">
                Alertas
              </p>
              <p className="text-purple-100 text-lg lg:text-xl font-bold">2</p>
            </div>
