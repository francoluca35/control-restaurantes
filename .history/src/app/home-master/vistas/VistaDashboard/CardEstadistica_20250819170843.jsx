...
export default function CardEstadistica({
  ...
  return (
    <div
      className={`bg-gradient-to-br ${bgColor} rounded-2xl p-6 border ${borderColor} shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1`}
    >
