...
export default function ResumenCards() {
  ...
  const resumen = [
    {
      ...
      valor: loading
        ? "..."
        : `$${(stats.ingresosAnuales?.USD || 0) + (stats.ingresosAnuales?.ARS || 0)?.toLocaleString() || "0"}`,
  ...
  const ingresosMensualesCards = [
    {
      ...
      valor: loading
        ? "..."
        : `$${
            stats.crecimientoAnual?.ingresosMensuales?.USD?.toLocaleString() ||
            "0"
          }`,
    ...
    },
    {
      ...
      valor: loading
        ? "..."
        : `$${
            stats.crecimientoAnual?.ingresosMensuales?.ARS?.toLocaleString() ||
            "0"
          }`,
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Tarjetas de ingresos mensuales */}
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 lg:gap-8">
        {ingresosMensualesCards.map((item, idx) => (
