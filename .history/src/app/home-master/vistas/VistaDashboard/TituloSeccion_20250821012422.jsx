  ...
  return (
    <div className="bg-gradient-to-r from-gray-800 to-gray-900 rounded-2xl shadow-2xl p-6 lg:p-8 border border-gray-700">
      ...
      <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4 lg:gap-6">
        ...
        <div className="bg-gradient-to-r from-green-900/50 to-green-800/50 rounded-xl p-4 lg:p-6 border border-green-700/50 backdrop-blur-sm">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-green-100 text-lg lg:text-xl font-bold">
                {loading ? "..." : stats.restaurantesActivos || "0"}
              </p>
            </div>
        ...
        <div className="bg-gradient-to-r from-red-900/50 to-red-800/50 rounded-xl p-4 lg:p-6 border border-red-700/50 backdrop-blur-sm">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-red-300 text-sm lg:text-base font-medium">
                Alertas
              </p>
              <p className="text-red-100 text-lg lg:text-xl font-bold">
                {loading ? "..." : stats.alertasTotales || "0"}
              </p>
            </div>
            <div className="w-3 h-3 lg:w-4 lg:h-4 bg-red-500 rounded-full animate-pulse"></div>
          </div>
        </div>
      </div>
    </div>
