  ...
  const handleDownloadContract = async (pago) => {
    try {
      ...
      const restaurant = {
        ...
        nombre: pago.restaurantName || pago.nombre || "Restaurante",
        ...
        codigoActivacion: pago.codigoActivacion || pago.externalReference || pago.restaurantId,
        password: pago.password || "N/A",
        periodicidad: pago.periodicidad || getPaymentPeriodicity(pago),
        cantUsuarios: pago.cantidadUsuarios || pago.cantUsuarios || "1",
        finanzas: pago.conFinanzas || pago.finanzas || false,
