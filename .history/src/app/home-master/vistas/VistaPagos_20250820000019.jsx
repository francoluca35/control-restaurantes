...
export default function VistaPagos() {
  ...
  // Cargar estadísticas cuando cambien los restaurantes
  useEffect(() => {
    ...
    <div className="text-white p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
        ...
        <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-400 text-sm">Ingresos Mensuales (USD)</p>
              <p className="text-2xl font-bold text-green-400">
                ${stats.ingresosMensuales?.USD?.toFixed(2) || "0.00"}
              </p>
            </div>
        ...
        <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-400 text-sm">Ingresos Mensuales (ARS)</p>
              <p className="text-2xl font-bold text-blue-400">
                ${stats.ingresosMensuales?.ARS?.toFixed(2) || "0.00"}
              </p>
            </div>
