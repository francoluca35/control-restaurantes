    ...
    async (data) => {
      try {
        ...
        if (data.formaPago === "mercadopago") {
          ...
          // Asegurar que el restaurante tenga un ID
          const restaurantWithId = {
            ...createdRestaurant,
            id: createdRestaurant.id || createdRestaurant.nombre?.replace(/\s+/g, '_').toLowerCase(),
            moneda: data.moneda || "ARS"
          };
          
          setCreatedRestaurant(restaurantWithId);
