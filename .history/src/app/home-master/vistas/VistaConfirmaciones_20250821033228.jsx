  ...
  const handleDownloadContract = async (pago) => {
    try {
      setDownloadingContract(pago.id);
            ...
            // Debug: mostrar datos del pago
      console.log("Datos del pago:", pago);
      console.log("Restaurantes disponibles:", restaurants);
      ...
      if (!restaurant) {
        restaurant = {
          ...
          direccion:
            pago.address || pago.direccion || "Dirección no especificada",
          telefono: pago.phone || pago.telefono || "Teléfono no especificado",
          email: pago.email || "Email no especificado",
          codigoActivacion:
            pago.codigoActivacion || pago.activationCode || "N/A",
      ...
      restaurant.codigoActivacion =
        ...
        "N/A";
      restaurant.password =
        restaurant.password || pago.password || pago.contraseña || "N/A";
