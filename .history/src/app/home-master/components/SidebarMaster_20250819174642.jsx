    ...
    <>
      ...
      {!abierto && (
        <button
          ...
          className="fixed top-6 left-6 z-50 bg-gradient-to-r from-blue-500 to-purple-600 text-white p-4 rounded-xl shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-110 border border-blue-400/30 backdrop-blur-sm"
          title="Abrir menú"
        >
          <FaBars size={22} />
        </button>
