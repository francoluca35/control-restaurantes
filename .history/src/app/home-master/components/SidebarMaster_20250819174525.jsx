    ...
    <>
      ...
      {!abierto && (
        <button
          ...
          className="fixed top-4 left-4 z-50 bg-gradient-to-r from-blue-500 to-purple-600 text-white p-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105"
        >
          <FaBars size={20} />
        </button>
      )}
