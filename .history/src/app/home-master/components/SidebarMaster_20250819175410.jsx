...
export default function Sidebar({ onChangeVista, onSidebarToggle }) {
  ...
  return (
    <>
      <div
        ref={sidebarRef}
        className="fixed left-0 top-0 h-screen w-64 bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 border-r border-gray-700/50 flex flex-col justify-between shadow-2xl z-50"
      >
        {/* Header */}
        <div className="p-4">
          {/* Logo/Brand */}
