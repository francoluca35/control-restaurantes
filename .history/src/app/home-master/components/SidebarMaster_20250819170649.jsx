...
const opciones = [
  { id: "inicio", label: "Dashboard", icon: FaHome, color: "from-blue-500 to-cyan-500" },
  { id: "restaurantes", label: "Restaurantes", icon: FaStore, color: "from-green-500 to-emerald-500" },
  { id: "pagos", label: "Pagos", icon: FaMoneyBill, color: "from-yellow-500 to-orange-500" },
  { id: "activacion", label: "Activación", icon: FaToggleOn, color: "from-purple-500 to-pink-500" },
];
...
export default function Sidebar({ onChangeVista }) {
  ...
  return (
    <div
      className={`h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 border-r border-gray-700/50 transition-all duration-300 ease-in-out ${
        abierto ? "w-64" : "w-20"
    ...
    >
      ...
      <div className="p-4">
        {/* Logo/Brand */}
        <div className={`flex items-center ${abierto ? "justify-start" : "justify-center"} mb-8`}>
        ...
        {/* User Profile */}
        <div className={`flex items-center ${abierto ? "justify-start" : "justify-center"} mb-6`}>
              ...
              >
                <div className={`relative ${abierto ? "mr-3" : ""}`}>
                  <Icon
                    ...
                    className={`transition-all duration-200 ${
                      activo ? "text-white" : "text-gray-400 group-hover:text-white"
                    }`}
                  />
                  {activo && (
                ...
                {abierto && (
                  <span className={`font-medium text-sm transition-all duration-200 ${
                    activo ? "text-white" : "text-gray-300 group-hover:text-white"
                  }`}>
                    {label}
                  </span>
                )}
      ...
      <div className="p-4 border-t border-gray-700/50">
        ...
        >
          ...
          {abierto && <span className="font-medium text-sm">Cerrar Sesión</span>}
        </button>

        {/* Toggle Button */}
        <button
          onClick={() => setAbierto(!abierto)}
          className={`mt-4 w-full flex items-center justify-center px-3 py-2 rounded-lg bg-gray-700/50 text-gray-300 hover:bg-gray-600/50 hover:text-white transition-all duration-200 ${
