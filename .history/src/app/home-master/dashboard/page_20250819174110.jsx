...
export default function DashboardMaster() {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black">
      <SidebarMaster onChangeVista={setVista} onSidebarToggle={setSidebarAbierto} />
      <main className={`flex-1 overflow-auto w-full lg:w-auto transition-all duration-300 ease-in-out ${
