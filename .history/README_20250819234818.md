...
- **Sistema de Pagos**: Integración con Mercado Pago para tarjetas de crédito/débito
- **Pagos en Efectivo**: Suma directa a ingresos mensuales
...
El sistema soporta dos métodos de pago para la activación de restaurantes:

### Efectivo
- Se suma directamente a los ingresos mensuales
- El restaurante se marca como "pagado" inmediatamente
